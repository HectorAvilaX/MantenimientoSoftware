...
class Product:
    ...
    def __init__(self, window):
        ...
        #descp input 
        Label(frame, text='Descp').grid(row=3, column=0)
        self.descp = Entry(frame)
        self.descp.grid(row=3, column=1)
        ...
        self.tree.heading('2', text='Descp', anchor = CENTER)
    ...
    def validation(self):
        return len(self.name.get()) != 0 and len(self.price.get()) != 0 and len(self.descp.get()) != 0 #lectura del input
    ...
    def edit_records(self, new_name, name, new_price, old_price, new_descp, old_descp):
        ...
        #query = 'UPDATE product SET name = "hola"'
